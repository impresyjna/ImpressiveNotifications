#
#  Be sure to run `pod spec lint ImpressiveNotifications.podspec' to ensure this is a
...
Pod::Spec.new do |spec|
  ...
  # Or just: spec.author    = "Asia Kasprzycka"
  # spec.authors            = { "Asia Kasprzycka" => "impresyjna@gmail.com" }
  # spec.social_media_url   = "https://twitter.com/Asia Kasprzycka"
  ...
  spec.source_files  = "ImpressiveNotificatins/Sources/**/*.swift"
